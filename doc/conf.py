...
# set __version__
try:
    with open('../qoqo_myqlm/__version__.py') as f:
        lines = f.readlines()
...
htmlhelp_basename = 'qoqomyqlmdoc'
...
latex_documents = [
    (master_doc, 'qoqomyqlm.tex', 'qoqo myqlm Documentation',
...
man_pages = [
    (master_doc, 'qoqo_myqlm', 'qoqo myqlm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qoqo_myqlm', 'qoqo myqlm Documentation',
     author, 'qoqo_myqlm', 'One line description of project.',
     'Miscellaneous'),
]
